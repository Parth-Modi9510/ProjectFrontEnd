        ...
        return(
            ...
            <div style={{textAlign:"center"}}>
                ...
                <Modal isOpen={this.state.ModalState} onRequestClose={this.toggleChange}>
                    ...
                    <div>
                        <input id="newid" type="text" placeholder="newusername" onChange={(e)=>{this.onIdChange(e)}}></input><br/>
                        <input id="newpassword" type="password" placeholder="newpassword" onChange={(e)=>{this.onIdChange(e)}}></input><br/>
